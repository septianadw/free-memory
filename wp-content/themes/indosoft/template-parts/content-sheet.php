...
function bp_sheet_add_metabox() {
    add_meta_box('sheet', __('sheet', 'indosoft'), 'bp_sheet_add_metaboxes', 'sheet', 'normal', 'high');
}
...
function bp_sheet_add_metaboxes() {
    ...
    printf( '<p><label for="%s">%s</label></p>', '_bp_sheet_file', __('Sheet File', 'indosoft') );
    ...
    printf( '<button type="button" class="button new bp_sheet_file" id="bp_sheet_file">%s</button>', __('Insert File', 'indosoft'));
} // end _myhome_upload
